        ...
        <div className="flex items-center h-20">
          ...
          <Link to="/" className="flex items-center space-x-2 min-w-0 lg:flex-1">
            ...
            <div className="flex flex-col min-w-0">
              <h1 className="text-lg sm:text-2xl font-bold text-gray-900 font-serif italic bg-gradient-to-r from-amber-700 to-amber-900 bg-clip-text text-transparent truncate">
